...
class ValidateTransformer < Transformer
  ...
  def process_schema(schema)
    @properties_tags_schema = schema.tags_schema || JsonSchema.new({ type: 'object', additionalProperties: false })
    @properties_natives_schema = schema.natives_schema || JsonSchema.new({ type: 'object', additionalProperties: false })
