...
require './datasources/connectors/tourinsoft_v3_cdt40'
require './datasources/connectors/tourinsoft_v3_cdt66'
require './datasources/connectors/tourinsoft_v3_cdt87'
require './datasources/connectors/tourism_system'
require './datasources/sources/geojson'
require './datasources/sources/geojson_tags_natives'
require './datasources/sources/grist'
require './datasources/destinations/destination'
require './datasources/destinations/geojson'
require './datasources/transforms/cinor'
...
require './datasources/transforms/log'
    ...
    job = Kiba.parse do
      ...
      sources.each{ |src|
        if src[:class] <= Connector
          ...
          source(src[:class], job_id, job_id, nil, src[:class].const_get(:Settings).from_hash(src[:settings]))
        end
      }
